  ...
  configs: [
    %{
      ...
      files: %{
        ...
        excluded: ["test/support/envio.ex", "test/envio_test.exs", "test/camarero_test.exs"]
      },
      #
      ...
      checks: [
        ...
        {Credo.Check.Design.AliasUsage,
         [priority: :low, if_nested_deeper_than: 2, if_called_more_often_than: 2, excluded_namespaces: ["Md.Parser.Syntax"]]},
